...
public enum ETerritory {
	...
	RightSide(ClientHalfMap.LAST_COORDINATES, LongGameMap.LAST_COORDINATES), None(new Coordinates(), new Coordinates()); // default
																															// value
	...
	public boolean contains(Coordinates coordinates) { // MAKE SURE it works correctly (Unit test / mockup)
		return (coordinates.smallerOrEqualTo(this.lastCoordinates)
				&& !coordinates.smallerOrEqualTo(preFirstCoordinates));
	}
